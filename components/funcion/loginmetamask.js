...
//     const chainId = await window.ethereum.request({ method: 'eth_chainId', params: ['0xaa36a7'] }); // Obtener el chainId actual
//     if (chainId === '0xaa36a7') { // Comprobar si ya está conectado a Goerli
